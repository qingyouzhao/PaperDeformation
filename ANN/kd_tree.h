...
public:
	...
	virtual void ann_search1(ANNdist box_dist,ANNmin_k	*	mink,int				&	ptsVisited,ANNpoint * kqd) = 0;		// tree search
...
public:
	...
	virtual void ann_search1(ANNdist box_dist,ANNmin_k		*	mink,int				&	ptsVisited,ANNpoint * kqd);
